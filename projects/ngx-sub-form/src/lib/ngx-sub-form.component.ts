...
export class FormControlNameRequiredError extends Error {
  message = `Passing the "formControlName" is required to have NgxSubForm working`;
}
...
export abstract class NgxSubFormComponent<ControlInterface, FormInterface = ControlInterface>
  ...
  public ngOnInit(): void {
    ...
    if (!this.formControlName) {
      throw new FormControlNameRequiredError();
    }
